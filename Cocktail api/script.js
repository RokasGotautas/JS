...
function randomizeFilters() {
    const randomCategoryIndex = getRandomIndex(selectValues.categories);
    const randomGlassIndex = getRandomIndex(selectValues.glasses);
    const randomIngredientIndex = getRandomIndex(selectValues.ingredients);

    categorySelectElement.value = selectValues.categories[randomCategoryIndex];
    glassSelectElement.value = selectValues.glasses[randomGlassIndex];
    ingredientSelectElement.value = selectValues.ingredients[randomIngredientIndex];
